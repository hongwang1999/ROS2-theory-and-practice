...
{
  base_interfaces_demo__srv__AddInts_Request * msg = (base_interfaces_demo__srv__AddInts_Request *)malloc(sizeof(base_interfaces_demo__srv__AddInts_Request));
  if (!msg) {
    return NULL;
  }
...
base_interfaces_demo__srv__AddInts_Request__Sequence__init(base_interfaces_demo__srv__AddInts_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (base_interfaces_demo__srv__AddInts_Request *)calloc(size, sizeof(base_interfaces_demo__srv__AddInts_Request));
    if (!data) {
      return false;
    }
...
{
  base_interfaces_demo__srv__AddInts_Request__Sequence * array = (base_interfaces_demo__srv__AddInts_Request__Sequence *)malloc(sizeof(base_interfaces_demo__srv__AddInts_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  base_interfaces_demo__srv__AddInts_Response * msg = (base_interfaces_demo__srv__AddInts_Response *)malloc(sizeof(base_interfaces_demo__srv__AddInts_Response));
  if (!msg) {
    return NULL;
  }
...
base_interfaces_demo__srv__AddInts_Response__Sequence__init(base_interfaces_demo__srv__AddInts_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (base_interfaces_demo__srv__AddInts_Response *)calloc(size, sizeof(base_interfaces_demo__srv__AddInts_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  base_interfaces_demo__srv__AddInts_Response__Sequence * array = (base_interfaces_demo__srv__AddInts_Response__Sequence *)malloc(sizeof(base_interfaces_demo__srv__AddInts_Response__Sequence));
  if (!array) {
    return NULL;
  }
