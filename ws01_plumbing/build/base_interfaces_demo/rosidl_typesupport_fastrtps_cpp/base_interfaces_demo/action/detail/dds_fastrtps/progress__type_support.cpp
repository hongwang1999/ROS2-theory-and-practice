...
{
  return max_serialized_size_Progress_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_Progress_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_Progress_Feedback(full_bounded, 0);
}
...
{
  return max_serialized_size_Progress_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_Progress_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_Progress_GetResult_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_Progress_GetResult_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_Progress_FeedbackMessage(full_bounded, 0);
}
